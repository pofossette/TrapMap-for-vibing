...
export interface GraphRecallTrace {
  ...
  backendKind: import('./context.js').KnowledgeReadGraphQueryRuntimeState['backendKind'];
  backendMode: import('./context.js').KnowledgeReadGraphQueryRuntimeState['mode'];
...
export interface RecallExecutionResult {
  scoredEntries: import('./retrieval-types.js').ScoredEntry[];
  mergedCandidates?: import('./retrieval-types.js').MergedCandidate[];
...
export async function hybridRecall(
  ...args: Parameters<typeof _hybrid>
): ReturnType<typeof _hybrid> {
  return _hybrid(...args);
}
export async function semanticRecall(
  ...args: Parameters<typeof _semantic>
): ReturnType<typeof _semantic> {
  return _semantic(...args);
}
export async function graphAssistedHybridRecall(
  ...args: Parameters<typeof _graph>
): ReturnType<typeof _graph> {
  return _graph(...args);
}
