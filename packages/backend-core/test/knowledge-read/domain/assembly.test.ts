...
function createScored(entry: MatchableEntryView, score = 0.8): ScoredEntryLike<MatchableEntryView> {
  return { entry, score };
}
      ...
      [
        {
          ...
          labels: [],
          score: 0.8,
          reason: 'semantic similarity (score: 0.80)',
        },
      ],
      [],
      'refined',
