...
import type { CandidateIngestionDeps } from '../../../src/candidate-ingestion/application/module.js';
import { createCandidateIngestionModule } from '../../../src/candidate-ingestion/application/module.js';
