/**
 * Service topology definitions for distributed deployment awareness.
 *
 * These types define the logical service boundaries and ownership model
 * for distributed TrapMap deployments. They are host-agnostic and describe
...
export const DEFERRED_ISOLATION_BOUNDARIES = [
  'per-service-database',
  'split-repository-packages',
  'service-mesh-event-backbone',
] as const;

export const DISTRIBUTED_SERVICES: readonly TopologyServiceDescriptor[] = [
  {
    name: 'gateway',
