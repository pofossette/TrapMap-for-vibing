...
function _makeOrderEdge(_sourceId: string, _targetId: string): GraphEdgeRecord {
  return {
    id: `skill:${_sourceId}->skill:${_targetId}:order`,
    sourceNodeId: `skill:${_sourceId}`,
    targetNodeId: `skill:${_targetId}`,
    relationType: 'order',
    strength: 'soft',
