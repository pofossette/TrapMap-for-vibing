...
import { knowledgeReadMineSchema } from '@trapmap/service-knowledge-read';
import { z } from 'zod';

import { createCronGatewayRouteDefs } from './gateway.cron-route-defs.js';
import { createRetrievalGatewayRouteDefs } from './gateway.retrieval-route-defs.js';
import {
  authContextSchema,
  emptyRecord,
...
export function createGatewayRouteDefs(deps: GatewayRouteDeps): RouteDef[] {
  return [
    ...
    ...createRetrievalGatewayRouteDefs(deps),
