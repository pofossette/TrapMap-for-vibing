...
vi.mock('../../../src/nest/runtime/shared-infra.js', () => ({
  createHostLocalSharedInfra: vi.fn(async () => sharedInfra),
}));
vi.mock('../../../src/nest/runtime/store-pool.js', () => ({
  getHostLocalStorePool: vi.fn(() => pool),
}));
vi.mock('../../../src/nest/runtime/runtime-deployment.js', () => ({
  resolveHostLocalDeployment: vi.fn(() => ({ runtimeMode: 'embedded', serviceUnit: 'host-local' })),
}));
vi.mock('../../../src/nest/runtime/retrieval-assembly.js', () => ({
...
import { createHostLocalServices } from '../../../src/nest/runtime/host-services.js';
