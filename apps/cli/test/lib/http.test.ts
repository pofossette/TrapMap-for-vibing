...
import type { CliState } from '../../src/lib/config.js';
import { ApiError, apiRequest, requireSessionToken } from '../../src/lib/http.js';
...
describe('apiRequest', () => {
  ...
  describe('network failures', () => {
    it('should include the request URL when fetch throws', async () => {
      ...
      const error = await apiRequest(defaultState, {
