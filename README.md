...
- PG-first 收敛已完成：各 service owner 通过 owner-local PostgreSQL bundle 管理数据。`packages/server`、`store_snapshot`、`JsonStore`、`PostgresStore` 已于 Wave-9/10 删除。详见 `docs/reference/SYSTEM_TRUTH_SOURCES.md`
