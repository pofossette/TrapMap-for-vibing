 ...
 */
export const trapsById: Map<string, TrapFixture> = new Map(
  allTraps.map((trap) => [trap.id, trap]),
);

/**
 * Category list for iteration.
 */
export const trapCategories = Object.keys(trapsByCategory) as Array<
  keyof typeof trapsByCategory
>;
