...
// =============================================================================
// Phase 7 Smoke Scenario: Label Filter (Summary)
// =============================================================================

/**
 * Scenario: Two artifacts with distinct labels (nodejs, python) for label-filter summary regression.
 * Nodejs artifact has an Express.js middleware capsule; python artifact has a Flask capsule.
 * When filtered by `labels: ['nodejs']`, summary must not contain Flask claims.
 */
export const summarySmokeLabelFilterScenario = retrievalEvalScenarioSchema.parse({
  scenarioId: 'summary-smoke-label-filter',
  description:
    'Two artifacts with distinct labels (nodejs vs python). Label-filtered summary must not include Flask claims.',
  actor: {
    subjectType: 'user',
    activeTeamId: 'team_smoke',
    securityLevel: 5,
  ...
  fixtures: {
    ...
    skillArtifacts: [
      {
        id: 'artifact_summary_label_filter_node',
        teamId: 'team_smoke',
        scope: 'project',
        ...
        capsules: [
          {
            capsuleId: 'capsule_summary_label_filter_node',
            content:
      ...
      {
        id: 'artifact_summary_label_filter_python',
        teamId: 'team_smoke',
        scope: 'project',
        ...
        capsules: [
          {
            capsuleId: 'capsule_summary_label_filter_python',
            content:
...
export const summarySmokeScenariosMap: Record<string, RetrievalEvalScenario> = {
  ...
  'summary-smoke-label-filter': summarySmokeLabelFilterScenario,
};
