...
- [x] **BOUND-04**: Retrieval ranking filters on required constraint mismatch, penalizes on excluded constraint match, and boosts on preferred constraint match
- [x] **BOUND-05**: API responses include boundary explanations showing why results are applicable or potentially inapplicable
