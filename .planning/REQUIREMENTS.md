...
- [ ] **DECAY-01**: Maintainer can configure knowledge lifecycle states (review-due / stale / expired / superseded) with automatic state transitions based on time and usage patterns
...
- [ ] **DECAY-04**: System applies soft decay (ranking penalty) for stale knowledge and hard decay (exclusion from default retrieval) for expired/superseded knowledge
...
|-------------|-------|--------|
| DECAY-01 | Phase 48 | Pending |
| DECAY-02 | Phase 49 | Pending |
| DECAY-03 | Phase 50 | Pending |
| DECAY-04 | Phase 48 | Pending |
