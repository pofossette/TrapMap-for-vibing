# B-heavy — CLI Integration Report (2026-09-02)

> Three runs via stub-gateway B-heavy on 4000 + Go stubs on 4100/4101, postgres via docker pgvector:pg16

## Runs
- **run-01**: p50=742 p95=808 | health: `{"status":"ok","service":"stub-gateway","artifact":"A-light","uptime":759.996475`
- **run-02**: p50=734 p95=766 | health: `{"status":"ok","service":"stub-gateway","artifact":"A-light","uptime":216.747195`
- **run-03**: p50=720 p95=747 | health: `{"status":"ok","service":"stub-gateway","artifact":"A-light","uptime":232.215929`
...
d7h20kb03tz6    source.local   7.12kB    38 minutes ago   29 minutes ago   3         false
w1uj2ddtweu6    source.local   443B      38 minutes ago   29 minutes ago   3         false
1h9wymtrjve3    source.local   4.02MB    37 minutes ago   29 minutes ago   2         false
kjseincu6frq    regular        603kB     36 minutes ago   29 minutes ago   1         false
```
```
cat: benchmarks/results/cli-integration/B-heavy/run-01/host-df.txt: No such file or directory
```

## CLI Timings (run-01)
```jsonl
{"cmd":"about","name":"about","ms":707,"exitCode":0}
{"cmd":"api:list","name":"api-list","ms":718,"exitCode":0}
{"cmd":"search test-trap","name":"search","ms":709,"exitCode":0}
{"cmd":"skill find --json","name":"skill-find","ms":654,"exitCode":0}
{"cmd":"skill search-by-content trap-content","name":"skill-search-by-content","ms":707,"exitCode":0}
{"cmd":"skill find","name":"skill-find-nojson","ms":761,"exitCode":0}
```
