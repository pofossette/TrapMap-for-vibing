...
- Phase 1-2 已提交；Phase 3 完成 snapshot loaders、deterministic rule extractor、validation/safety gates 和 rule-first orchestration 检查点，task wiring/LLM/staleness 仍在执行中。
