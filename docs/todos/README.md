...
| 文件 | 主题 | 状态 |
|---|---|---|
| [skill-lookup-surface-mainline.md](skill-lookup-surface-mainline.md) | Skill Lookup 契约漂移修复（真实端点 + 三面对齐 + 防复发守卫） | active mainline（2026-08-22 激活，执行中） |
