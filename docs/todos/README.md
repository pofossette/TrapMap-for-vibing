...
| 文件 | 主题 | 状态 |
|---|---|---|
| [debt-mcp-platformization-mainline.md](debt-mcp-platformization-mainline.md) | 债务全量派发 + Agent MCP 接入 + 微服务平台化（worktree + subagent-driven，三 worktree 并行） | **active**（2026-08-21 激活） |
