...
| 文件 | 主题 | 状态 |
|---|---|---|
| [judgment-node-contracts-d8.md](judgment-node-contracts-d8.md) | 判断类节点契约（D8）收编（契约优先：6 个判断类节点契约三件套 + rule 实现 + assembly 挂载） | active mainline（2026-08-16 激活） |
