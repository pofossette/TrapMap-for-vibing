...
| 文件 | 主题 | 状态 |
|---|---|---|
| [debt-mcp-platformization-mainline.md](../archived/archived-plans/debt-mcp-platformization-mainline-archived.md)（已归档） | 债务全量派发 + Agent MCP 接入 + 微服务平台化 | 已完成（2026-08-22 closeout），已归档 |
