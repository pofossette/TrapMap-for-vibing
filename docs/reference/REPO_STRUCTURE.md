...
- `packages/service-job-runtime/`: Fifth implemented service package. Owns job-runtime service assembly, internal route registration, queue/runtime deps wiring, and runtime server bootstrap surface.
