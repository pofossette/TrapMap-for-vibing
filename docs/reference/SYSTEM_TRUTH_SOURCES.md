...
16. Phase 4 closeout fact: the repository-level owner matrix, compatibility-shell retirement list, and distributed mature-service closeout task categories are frozen in `plan.md` and `docs/todos/nestjs-service-evolution-04-data-runtime-and-cutover.md`; follow-up docs must not invent a second matrix or reintroduce removed rollback/compat entrypoints as active runtime choices.
