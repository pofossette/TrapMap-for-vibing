...
| Light default host entry point (frozen mainline) | `plan.md` + `docs/todos/backend-build-targets-plan.md` + `packages/host-local/src/nest/app.module.ts` + `packages/host-local/src/nest/*/*.module.ts` (six bounded-context modules) + `packages/host-local/src/nest/main.ts` | `README.md`, `docs/README.md`, `docs/architecture/DEPLOYMENT.md`, `docs/PACKAGES.md` |
