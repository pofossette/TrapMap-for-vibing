...
| Nest modular monolith entry point (Phase 4 default) | `packages/host-local/src/nest/app.module.ts` + `packages/host-local/src/nest/*/*.module.ts` (six bounded-context modules) + `packages/host-local/src/config/host-config.ts` | `README.md`, `docs/README.md`, `docs/architecture/DEPLOYMENT.md`, `docs/PACKAGES.md` |
